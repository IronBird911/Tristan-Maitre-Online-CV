...
class Footer extends HTMLElement {
    ...
    <div class="container-fluid footer bg-dark">
        <div class="row justify-content-between">
            <div class="col-sm-4">
                <b>Copyright</b><br /> &copy; Tristan Maitre (2020) pset8 CS50x version
            </div>
            <div class="col-sm-4">
                <b>Write</b> <br /> <a href="mailto:hire.tristan.maitre@gmail.com">hire.tristan.maitre@gmail.com</a>
            </div>
            <div class="col-sm-2">
                <b>Call</b> <br /> +41 00 000 00 00
            </div>
            <div class="col-sm-2">
                <b>Stay in touch</b> <br /> 
                <a href="https://www.linkedin.com/in/tristanmaitre/" target="_blank"><i class="fa fa-linkedin" style="font-size:15px"></i></a>&nbsp;<a href="skype:tristan.maitre_1?call"><i class="fa fa-skype" style="font-size:15px"></i></a>
            </div>
        </div>
    </div>
    `;
